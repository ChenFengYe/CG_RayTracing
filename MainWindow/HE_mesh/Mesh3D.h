...
//	Vec3d	normal_;		//!< vertex normal
//	Vec3d	texCoord_;		//!< texture coord
//	Vec4d	color_;
...
//	Vec3d& normal(void) {return normal_;}
//	Vec3d& position(void) {return position_;}
//	Vec3d& texCoordinate(void) {return texCoord_;}
//	Vec4d& color(void) {return color_;};
//	int			degree(void) {return degree_;}
//	int			selected(void) {return selected_;}
//	BoundaryTag boundary_flag(void) {return boundary_flag_;}
//
//	void		set_normal(const Vec3d& n) {normal_=n;}
//	void		set_position(const Vec3d& p) {position_=p;}
//	void		set_id(int id) {id_=id;}
//	void		set_color(const Vec4d& c) {color_=c;}
...
//public:
//	int			id_;
//	HE_vert		*pvert_;		//!< vertex at the end of the half-edge //question!
...
//	Vec3d		texCoord_;		//!< texture coordinate of the end vertex
//	BoundaryTag boundary_flag_;	//!< boundary flag
//
//public:
//	HE_edge()
...
//	Vec4d		color_;			//!< the color of this face
...
//	*/
//	HE_vert* InsertVertex(const Vec3d& v);
//
//	//! insert an edge
...
//	void CreateMesh(const std::vector<Vec3d>& verts, const std::vector<int>& triIdx);
